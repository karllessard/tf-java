...
package org.tensorflow.impl.c_api.presets;
...
//                "tensorflow/c/env.h",
    ...
    target = "org.tensorflow.impl.c_api",
    global = "org.tensorflow.impl.c_api.global.tensorflow")
public class tensorflow implements LoadEnabled, InfoMapper {
    ...
    public void map(InfoMap infoMap) {
        infoMap.put(new Info("TF_CAPI_EXPORT").cppTypes().annotations())
               ...
               .put(new Info("TF_Status").pointerTypes("TF_Status").base("org.tensorflow.impl.c_api.AbstractTF_Status"))
               .put(new Info("TF_Buffer").pointerTypes("TF_Buffer").base("org.tensorflow.impl.c_api.AbstractTF_Buffer"))
               .put(new Info("TF_Tensor").pointerTypes("TF_Tensor").base("org.tensorflow.impl.c_api.AbstractTF_Tensor"))
               .put(new Info("TF_SessionOptions").pointerTypes("TF_SessionOptions").base("org.tensorflow.impl.c_api.AbstractTF_SessionOptions"))
               .put(new Info("TF_Graph").pointerTypes("TF_Graph").base("org.tensorflow.impl.c_api.AbstractTF_Graph"))
               ...
               .put(new Info("TF_ImportGraphDefOptions").pointerTypes("TF_ImportGraphDefOptions").base("org.tensorflow.impl.c_api.AbstractTF_ImportGraphDefOptions"))
               ...
               .put(new Info("TF_Session").pointerTypes("TF_Session").base("org.tensorflow.impl.c_api.AbstractTF_Session"))
