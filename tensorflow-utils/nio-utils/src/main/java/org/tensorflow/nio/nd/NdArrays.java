...
import org.tensorflow.nio.buffer.impl.heap.BooleanHeapDataBuffer;
import org.tensorflow.nio.buffer.impl.heap.ByteHeapDataBuffer;
import org.tensorflow.nio.buffer.impl.heap.DoubleHeapDataBuffer;
import org.tensorflow.nio.buffer.impl.heap.IntHeapDataBuffer;
import org.tensorflow.nio.buffer.impl.heap.LongHeapDataBuffer;
import org.tensorflow.nio.buffer.impl.heap.ShortHeapDataBuffer;
...
public final class NdArrays {
  ...
  public static ByteNdArray ofBytes(Shape shape) {
    ...
    return wrap(ByteHeapDataBuffer.allocate(shape.size()), shape);
  }
  ...
  public static LongNdArray ofLongs(Shape shape) {
    return wrap(LongHeapDataBuffer.allocate(shape.size()), shape);
  }
  ...
  public static IntNdArray ofInts(Shape shape) {
    return wrap(IntHeapDataBuffer.allocate(shape.size()), shape);
  }
  ...
  public static ShortNdArray ofShorts(Shape shape) {
    return wrap(ShortHeapDataBuffer.allocate(shape.size()), shape);
  }
  ...
  public static DoubleNdArray ofDoubles(Shape shape) {
    return wrap(DoubleHeapDataBuffer.allocate(shape.size()), shape);
  }
  ...
  public static BooleanNdArray ofBooleans(Shape shape) {
    return wrap(BooleanHeapDataBuffer.allocate(shape.size()), shape);
  }
