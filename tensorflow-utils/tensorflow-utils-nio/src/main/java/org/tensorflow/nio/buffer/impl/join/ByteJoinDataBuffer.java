...
public final class ByteJoinDataBuffer extends
    AbstractJoinDataBuffer<Byte, ByteDataBuffer> implements ByteDataBuffer {
  ...
  @Override
  protected ByteJoinDataBuffer instantiate(ByteDataBuffer[] buffers, boolean readOnly) {
    return new ByteJoinDataBuffer(buffers, readOnly);
  }

  private ByteJoinDataBuffer(ByteDataBuffer[] buffers, boolean readOnly) {
