...
public final class DoubleJoinDataBuffer extends
    AbstractJoinDataBuffer<Double, DoubleDataBuffer> implements DoubleDataBuffer {
  ...
  @Override
  protected DoubleJoinDataBuffer instantiate(DoubleDataBuffer[] buffers, boolean readOnly) {
    return new DoubleJoinDataBuffer(buffers, readOnly);
  }

  private DoubleJoinDataBuffer(DoubleDataBuffer[] buffers, boolean readOnly) {
